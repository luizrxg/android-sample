...
class BuscarWishesCompradosUltimoMes @Inject constructor(
    private val wishRepository: WishRepository
) : PagingInteractor<BuscarWishesCompradosUltimoMes.Params, Wish>() {
    ...
    override suspend fun createObservable(
        ...
        wishRepository.buscarWishesCompradosUltimoMes()
